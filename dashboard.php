...
<head>
  ...
  <title>Venue Check| Dashboard</title>
        ...
        <?php endif;?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
<?php $query1=mysqli_query($con,"select * from venuebookings");
...
?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
 <?php $query3=mysqli_query($con,"select * from venuebookings where (boookingStatus is null || boookingStatus='')");
...
<hr />
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
<?php $query11=mysqli_query($con,"select * from venuebookings where (boookingStatus='Accepted')");
...
?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
<?php $query12=mysqli_query($con,"select * from venuebookings where (boookingStatus='Rejected')");
